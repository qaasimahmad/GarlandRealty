        ...
        <div className="container">
          ...
          <div className="row ltn__custom-gutter--- justify-content-center go-top">
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="ltn__feature-item ltn__feature-item-6 text-center bgColor text-white  box-shadow-1">
                ...
                <div className="ltn__feature-info">
                  ...
                  <Link style={aStyle} className="ltn__service-btn" to="/service-details">
                    Find A Home
                  </Link>
                </div>
              </div>
